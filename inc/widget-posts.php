...
function hotel_wp_lite_latest_posts_widget() {
	register_widget( 'hotel_wp_lite_latest_posts_widget' );
}
add_action( 'widgets_init', 'hotel_wp_lite_latest_posts_widget' );

// Creating the widget 
class hotel_wp_lite_latest_posts_widget extends WP_Widget {

function __construct() {
parent::__construct(

// Base ID of your widget
'hotel_wp_lite_latest_posts_widget', 

// Widget name will appear in UI
__('Advanced Recent Posts', 'hotel-wp-lite'), 

// Widget description
array( 'description' => __( 'Display latest_posts with featured image and Meta', 'hotel-wp-lite' ), ) 
);
}
...
$title = ( ! empty( $instance['title'] ) ) ? strip_tags( apply_filters( 'widget_title', $instance['title'] ) ) : __( 'Recent Posts', 'hotel-wp-lite' );
...
hotel_wp_lite_get_latest_posts($max_items);
...
<p>
<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title:','hotel-wp-lite' ); ?></label> 
<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
</p>
<p>
<label for="<?php echo esc_attr($this->get_field_id( 'max_items' )); ?>"><?php esc_html_e( 'Number of posts to Show:','hotel-wp-lite'  ); ?></label> 
...
<label for="<?php echo esc_attr($this->get_field_id( 'hide_title' )); ?>"><?php esc_html_e( 'Hide Widget Title','hotel-wp-lite' ); ?></label> 
</p>
<?php 
}
...
public function update( $new_instance, $old_instance ) {
	$instance = array();
	$instance['title'] = ( ! empty( $new_instance['title'] ) ) ? sanitize_text_field( $new_instance['title'] ) : esc_html_e( 'Advanced Recent Posts','hotel-wp-lite' );
...
function hotel_wp_lite_get_latest_posts($max){
